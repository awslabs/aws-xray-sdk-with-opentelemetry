...
public class RecorderBackedTracer implements Tracer {
     ...
     * {@inheritDoc}
     *
     * This implementation will automatically update the active span based on changes to the X-Ray recorder but
     * otherwise conforms to OpenTelemetry semantics when creating spans.
     */
